 ...
 * Кэширует в бинарный формат для последующего "мгновенного" чтения, таким образом можно сравнить затраты на обработку JSON и RAW.
 *
 * Очевидно, что подготовка "raw" данных для обработки эффективна не только на мобильных устройствах, но и серверными приложениями.
 * Вопрос только в правильной "готовке" и сегментации по типам: справочники/данные.
 *
 */
